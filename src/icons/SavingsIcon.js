...
const SavingsIcon = ({ size = '16', fill = '#eee' }) => (
  <svg
    version="1.1"
    id="Capa_1"
    ...
    with={`${size}px`}
    height={`${size}px`}
    viewBox="0 0 331.493 331.493"
    xmlSpace="preserve"
  >
    <path
      fill={fill}
      d="M298.761,57.093l-101.2-54.8c-9.6-5.2-22.8-1.2-28,8.4l-59.2,110h-72c-9.2,0-16.4,7.2-16.4,16.4v28.8v149.2
    ...
    <path
      fill={fill}
      d="M271.161,72.693l-3.2-1.6c-8-4.4-18.8-1.2-23.2,6.8l-4,7.6c-2,4-2.8,8.8-1.2,13.2c1.2,4.4,4.4,8,8.4,10l3.2,1.6
